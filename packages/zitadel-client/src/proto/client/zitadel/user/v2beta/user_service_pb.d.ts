...
export class AddHumanUserRequest extends jspb.Message {
  ...
  getOrganisation(): zitadel_object_v2beta_object_pb.Organisation | undefined;
  setOrganisation(value?: zitadel_object_v2beta_object_pb.Organisation): AddHumanUserRequest;
...
export namespace AddHumanUserRequest {
  export type AsObject = {
    userId?: string,
    username?: string,
    organisation?: zitadel_object_v2beta_object_pb.Organisation.AsObject,
...
export class GetUserByIDResponse extends jspb.Message {
  ...
  getUser(): zitadel_user_v2beta_user_pb.HumanUser | undefined;
  setUser(value?: zitadel_user_v2beta_user_pb.HumanUser): GetUserByIDResponse;
  hasUser(): boolean;
...
export namespace GetUserByIDResponse {
  export type AsObject = {
    details?: zitadel_object_v2beta_object_pb.Details.AsObject,
    user?: zitadel_user_v2beta_user_pb.HumanUser.AsObject,
  }
}
